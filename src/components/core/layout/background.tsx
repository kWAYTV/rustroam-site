...
export function Background() {
  return (
    <>
      ...
      <div className='pointer-events-none absolute inset-0 animate-gradient-xy bg-gradient-to-tr from-orange-500/5 via-red-500/5 to-orange-500/5' />

      {/* Grid patterns */}
      <div className='pointer-events-none absolute inset-0 bg-grid-small' />
      <div className='pointer-events-none absolute inset-0 bg-grid-large' />
